...
for (ind in 1:3){
  ...
  wht <- wilcox.test(x = score_clim[i,t,1,], y = score_ps[i,t,1,] ,alternative = "less", paired = TRUE, conf.level = 0.95)
  wlt <- wilcox.test(x = score_clim[i,t,2,], y = score_ps[i,t,2,] ,alternative = "less", paired = TRUE, conf.level = 0.95)
