...
#    1st tercile = lower tercile; 2nd = middle; 3rd = upper
  ...
  maprev [[m]]<- qtm(shp_tercile[[m]], fill = "tercile",
     attr.outside = TRUE,borders = NULL, fill.style="fixed",fill.breaks=c(1,2,3,4),fill.palette = rain_palette, legend.fill.show=FALSE)+ 
 tm_shape(shp_conf[[m]])+
...
com_legend <- qtm(shp_tercile[[m]], fill = "tercile",
     attr.outside = TRUE,borders = NULL, fill.style="fixed",fill.breaks=c(1,2,3,4),fill.palette = rain_palette)+  
